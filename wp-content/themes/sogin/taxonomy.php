    ...
    <div class="category">
        <div class="left_menu">
            ...
            foreach ($types_list as $key => $type){
                ...
                $terms = get_terms( $head_term->taxonomy, $args );
                if ($terms){
                    ?>
                    <div class="category_group">
                        ...
                        <ul>
                            <?php foreach ($terms as $term){ ?>
                                <li>
                                    <a <?php if ($head_term->term_id == $term->term_id){ ?> class="current" <?php } ?> href="/<?php echo $term->taxonomy. '/' . $term->slug?>"><?php echo $term->name; ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
        ...
        <div class="category_inner">
            ...
            <div class="products">
                ...
                $query = new WP_Query( $args = array(
                    ...
                    'tax_query' => array(
                            array(
                            'taxonomy' => $head_term->taxonomy,
                            'terms' => $head_term->term_taxonomy_id,
                            'field' => 'id',
